# Návrh textů – Marian Vystavěl (IT junior / student)

> **Poznámka:** Všech 64 stavů odpovídá originální stupnici od „lhostejný" (stav 1) po „hyper-agresivní" (stav 64).  
> HTML tagy a linky jsou zachovány ve stejné logice jako v předloze. Místa jako `/cv`, `/portfolio`, `/projekty`, `/dovednosti`, `/kontakt` jsou orientační – uprav dle skutečné struktury webu.

---

## Stav 1
`Takže jo, jsem student IT. No a co jako?`

---

## Stav 2
`Jestli potřebujete juniora, můžete mi napsat. Nebo taky ne.`

---

## Stav 3
`Jestli potřebujete juniora, můžete mi zkusit napsat. Je to celkem na vás.`

---

## Stav 4
`Klidně to ignorujte, ale jestli sháníte juniora, možná bych stál za zkoušku. Myslím, že moje projekty jsou celkem slušné, ale třeba to není úplně váš styl. Posuďte sami.`

---

## Stav 5
`Klidně to ignorujte, ale jestli sháníte celkem <a href="/cv">motivovaného</a> juniora, možná bych stál za zkoušku. Myslím, že moje projekty jsou celkem slušné, ale třeba to není váš styl. Posuďte sami.`

---

## Stav 6
`Klidně to ignorujte, ale jestli sháníte celkem <a href="/cv">motivovaného</a> juniora, možná bych stál za zkoušku. Moje projekty jsou obvykle celkem slušné a zvládnu věci od webových aplikací po databázové systémy. Moje technická řešení nemůžou být úplně marná, jinak by mě spolužáci a učitelé pořád neprosili o pomoc.`

---

## Stav 7
`Jestli sháníte celkem <a href="/cv">motivovaného</a> juniora, možná bych stál za zkoušku. Moje projekty jsou obvykle celkem slušné a zvládnu věci od webových aplikací po databázové systémy. Moje technická řešení nemůžou být úplně marná, jinak by mě spolužáci a učitelé pořád neprosili o pomoc.`

---

## Stav 8
`Jestli sháníte celkem <a href="/cv">motivovaného</a> juniora, možná bych stál za zkoušku. Moje projekty jsou dost dobré a zvládnu věci od webových aplikací po databázové systémy. Moje technická řešení nemůžou být úplně marná, jinak by mě lidé kolem pořád neprosili o pomoc.`

---

## Stav 9
`Jestli sháníte celkem <a href="/cv">motivovaného</a> juniora, možná bych stál za zkoušku. Moje projekty jsou dost dobré a mám za sebou i pár <a href="/projekty">vlastních aplikací</a>. Zvládnu věci od webových aplikací po databázové systémy. Moje technické nápady nemůžou být úplně marné, jinak bych se ve volném čase nepustil do tvorby vlastní <a href="/projekty">neuronové sítě</a>.`
...
## Stav 56
`<strong class="red">ZAREZERVUJTE SI MĚ. NEŽ TO UDĚLÁ VÁŠ KONKURENT.</strong><br><strong>OZVĚTE SE HNED TEĎ</strong> a získejte moje technické zkušenosti na svou stranu. Moje <a href="/projekty">práce</a> zahrnuje webové aplikace, vlastní neuronové sítě, OSINT nástroje a databázové architektury. Jsem neuvěřitelně flexibilní a zvládnu vše od frontendu po backend. Proto se na mě obracejí ti, kteří chtějí věci dotáhnout do konce. <strong>Napište mi HNED a získejte moje know-how.</strong>`

---

## Stav 57
`<strong class="red">FIRMA, SE KTEROU SOUTĚŽÍTE O ZAKÁZKU, BY SI MĚ MOHLA NAJMOUT.<br>RISKUJETE TO?</strong><br><strong>OZVĚTE SE HNED TEĎ</strong> a získejte moje technické zkušenosti na svou stranu. Moje <a href="/projekty">práce</a> zahrnuje webové aplikace, vlastní neuronové sítě, OSINT nástroje a databázové architektury. Jsem neuvěřitelně flexibilní a zvládnu vše od frontendu po backend. Proto se na mě obracejí ti, kteří chtějí věci dotáhnout do konce. <strong>Napište mi HNED a získejte moje know-how.</strong>`
...
- **Linky** – `/cv`, `/projekty`, `/dovednosti`, `/kontakt` jsou orientační; uprav dle skutečné URL struktury webu.
- **Telefon** – zachován originál z Info: `+420 730 939 804`
- **Email** – zachován originál: `mvystavel@seznam.cz`
- **Škola** – SPŠE Ječná, Praha 2 (studium od 2022)
- **Jazyky / technologie** – Java, C#, Python, JavaScript, MySQL, MS SQL Server
- **Projekty** – Region Beta Activity Planner, vlastní neuronová síť, OSINT nástroje, Flask webové aplikace
- **Osobní styl** – přímočarost, analytické myšlení, realistický přístup (dle Gemeni.txt)
