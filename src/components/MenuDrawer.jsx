    ...
    <nav className={`menu-drawer ${isOpen ? 'is-open' : ''}`} id="menu-drawer" ref={drawerRef}>
      ...
      <div className="menu-drawer_inner">
        <ul className="menu" id="menu-nav">
          <li>
            <Link to="/" className={isActive('/') ? 'is-current' : ''} onClick={onClose}>
              Portfolio
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/uspechy" className={isActive('/uspechy') ? 'is-current' : ''} onClick={onClose}>
              Úspěchy
            </Link>
          </li>
          <li>
          ...
          <li className="menu__sub">
            <Link to="/projekty/mapa" className={isActive('/projekty/mapa') ? 'is-current' : ''} onClick={onClose}>
              Mapa
            </Link>
          </li>
          <li className="menu__sub">
        ...
        <address>
          <a className="social-link" href="https://github.com/MonsterMarian" target="_blank" rel="noopener noreferrer" title="GitHub">
          ...
          <a className="social-link" href="https://www.linkedin.com/in/marian-vystav%C4%9Bl-0a21263a0/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
            <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
