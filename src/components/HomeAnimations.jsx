...
function HomeAnimations({ activeAnimation, sliderValue, maxSlider }) {
  ...
  return (
    <div className="home-animations" id="home-animations">
      ...
      <div className={`home-animation home-animation--8 home-animation--8__explosions ${activeAnimation >= 8 ? 'is-active' : ''}`}>
        {showExplosions && (
          <>
            <img src="/images/thumbs-up.png" style={{ position: 'fixed', top: '50%', left: 0, width: '50%', height: 'auto' }} className="center-y home-animation--8__explosion" alt="Exploze palců nahoru" />
            <img src="/images/thumbs-up.png" style={{ position: 'fixed', top: '50%', right: 0, width: '50%', height: 'auto' }} className="center-y home-animation--8__explosion" alt="Exploze palců nahoru" />
          </>
        )}
      </div>
    </div>
